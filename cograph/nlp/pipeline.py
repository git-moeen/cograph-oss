...
from cograph.models.query import NLResult
from cograph.nlp.prompts import SPARQL_GENERATION_SYSTEM, build_generation_prompt
from cograph.nlp.validator import normalize_sparql, validate_sparql
...
def get_embedding_service():
    ...
    if _embedding_service is None:
        ...
        if settings.openrouter_api_key:
            from cograph.nlp.ontology_embeddings import OntologyEmbeddingService
...
class NLQueryPipeline:
    ...
    async def ask(self, question: str, graph_uri: str, instance_graph: str | None = None, exclude_questions: list[str] | None = None) -> NLResult:
        ...
        examples_text = ""
        try:
            from cograph.nlp.example_bank import get_example_bank, format_examples_for_prompt
